...
export const FEATURE_COMPARISON = [
  {
    category: 'API Access',
    features: [
      { name: 'Monthly API calls', free: '750', pay_per_call: 'Unlimited', starter: '50,000', growth: '500,000', scale: '5,000,000', enterprise: 'Unlimited' },
      { name: 'Daily rate limit', free: '25', pay_per_call: '1,000', starter: '~1,667', growth: '~16,667', scale: '~166,667', enterprise: 'Unlimited' },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'x402 USDC payments (keyless)', free: 'Any call', pay_per_call: 'Any call', starter: 'Any call', growth: 'Any call', scale: 'Any call', enterprise: 'Any call' },
    ],
  },
  {
